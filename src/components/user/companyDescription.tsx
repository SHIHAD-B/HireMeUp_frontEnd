                    ...
                    <div className='w-[60%] h-full flex flex-col gap-6'>
                        ...
                        <div className='w-full flex flex-col gap-2'>
                            ...
                            <div className='w-full flex flex-wrap gap-1 '>
                                <div className='p-1 border text-customviolet border-customviolet'>{companyDatas?.website}</div>
                                <div className='p-1 border text-customviolet border-customviolet'>www.striffffffffffpe.com</div>
                                <div className='p-1 border text-customviolet border-customviolet'>www.strfipe.com</div>
                                <div className='p-1 border text-customviolet border-customviolet'>www.strfipe.com</div>
