...
import { addCompanyValidation } from '@/utils/validations/admin/addCompanyValidation';

export const AddCompany = ({ handleaddClose }: { handleaddClose: () => void }) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            await addCompanyValidation.validate(addData, { abortEarly: false });
            console.log("Validation successful");


            await axios.post(`${BASE_URL}company/admin/addcompany`, addData,{withCredentials:true}).then((res: any) => {
