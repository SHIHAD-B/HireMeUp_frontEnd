...
export const EditJob = () => {
    ...
    const stateJobData: IJobData = location.state?.jobData;

    useEffect(() => {
        console.log(location.state, "location state");

        if (!location.state) {
            console.log("Navigating to /company/joblist");
    ...
    const jobSubmit = async () => {
        try {
            ...
            await axios.patch(`${BASE_URL}job/company/editjob`, jobData,{withCredentials:true}).then((res) => {
                if (res.data.success) {
                    toast({
                ...
                <div className="flex h-full  relative">
                    ...
                    <div className="lg:w-[85%] w-full ">
                        ...
                        <div className="w-full p-6 flex flex-col gap-10 ">
                            <span className="flex gap-2 justify-start items-center font-bold text-md"><FaArrowLeft />Edit job</span>
