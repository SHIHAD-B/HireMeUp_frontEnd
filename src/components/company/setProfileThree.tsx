...
export const SetProfileThree = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            await axios.patch(`${BASE_URL}company/company/resetprofilepassword`, sendData,{withCredentials:true}).then((res: any) => {
                ...
                <div className="w-full h-[200px] border-b border-gray-200  lg:h-56 pl-2 flex flex-col lg:flex-row">
                    <div className="w-full lg:w-1/2  h-full flex justify-between items-center pt-2">
                        ...
                        <div className=" w- h-52 rounded-full flex flex-col items-center justify-center">
                            <span className='font-bold flex items-center gap-2'>{companydata?.email}<MdOutlineVerified className="text-green-400 text-xl" /></span>
                ...
                <div className='w-full flex pt-4 flex-col lg:flex-row  border-b border-gray-200'>
                    ...
                    <div className='w-full m-2 lg:w-2/5 flex flex-col gap-6'>
                        <div className='1/4 flex flex-col gap-2'>
                            ...
                            <input type="password" onChange={handleChange} name="password" value={data.password} className='bg-background w-full border rounded border-gray-400 h-10' />
                        ...
                        <div className='1/4 flex flex-col gap-2'>
                            ...
                            <input type="password" onChange={handleChange} name="newPassword" value={data.newPassword} className='bg-background w-full border rounded border-gray-400 h-10' />
                        ...
                        <div className='1/4 flex flex-col gap-2'>
                            ...
                            <input type="password" onChange={handleChange} name="confirmPassword" value={data.confirmPassword} className='bg-background w-full border rounded border-gray-400 h-10' />
