...
export const ExperienceModal = (data: IExperience) => {
    ...
    const continues = async () => {
        ...
        try {
            ...
            await axios.patch(`${BASE_URL}user/addexperience`, data, { withCredentials: true }).then((res: any) => {
                ...
                const data={
                    ...expData,
                    _id:res.data.user.experiences[res?.data?.user?.experiences?.length-1]._id
                }
                setUser((prev:any)=>({
                    ...prev,
